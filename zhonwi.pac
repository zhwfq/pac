...
function FindProxyForURL(u,h)
{
	...
	"geilitoday.org",
	"www.longvisit.com",
	"mms://76.73.60.108/3l.7592",
	"mms://tv1.sbkengdieweishi.com/ctv.852",
	"mms://wmslive.media.hinet.net/Weblive_CtitvNews_1200",
	"sourceforge.net",
	"chuantu.biz",
	"hkatvnews.com",
	"uc.udn.com.tw",
	"weibonews.weebly.com",
	"pixiv.net",
	"i2.pixiv.net",
	"glass8.eu",
	"cdn.akamai.steamstatic.com",
	"watch.porn-station.tv",
	"saurik.com",
	"m.freemyapps.com",
	"featurepoints.com",
	"spotify.com",
	...
	for(i=0;i<a.length;i++)
	{
		...
		{
			return "PROXY a.qypac.net:19018"
		}
	}
	if(/\.?blogspot\.\w{2}$/.test(h)||/\.google\.com\.\w{2}$/.test(h)||/(google\.\w{2}$|google\.co\.\w{2}$)/.test(h)||/rdio[^\.]*\.akamaihd\.net/.test(h)||/.*rdio.com/.test(h))
		return "PROXY a.qypac.net:19018";
	a=["tudou.com",
	"weibo.com",
	"xunlei.com",
	...
	for(i=0;i<a.length;i++)
	{
		if(dnsDomainIs(h,a[i]))
		{
			return "PROXY zhonwi.f3322.net:1080"
		}
	}
	return "DIRECT"
}
